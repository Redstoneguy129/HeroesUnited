...
public class SuitModel<T extends LivingEntity> extends HumanoidModel<T> {
    ...
    public SuitModel(ModelPart part, Entity entity) {
        this(part, HUPlayerUtil.haveSmallArms(entity));
    }

    public SuitModel(ModelPart part, boolean slim) {
...
/*
    ...
    public void renderArm(HumanoidArm handSide, PoseStack matrixStack, VertexConsumer vertexBuilder, int combinedLight, T entity) {
