...
public class AsteroidsBeltRenderer extends CelestialBodyRenderer {
    ...
    private ModelPart[] asteroids = new ModelPart[500];
    ...
    public AsteroidsBeltRenderer() {
        ...
        for (int i = 0; i < asteroids.length; i++) {
            Vec3d asteroidPosition = new Vec3d(1500 + (random.nextBoolean() ? random.nextInt(50) : -random.nextInt(50)), random.nextBoolean() ? random.nextInt(50) : -random.nextInt(50), random.nextBoolean() ? random.nextInt(50) : -random.nextInt(50)).rotateY(7 * i);
