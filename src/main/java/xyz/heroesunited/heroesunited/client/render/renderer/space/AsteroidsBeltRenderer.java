    ...
    public AsteroidsBeltRenderer() {
        ...
        for (int i = 0; i < asteroids.length; i++) {
            ...
            asteroids[i].addBox(0, 0, 0,
                    random.nextFloat() + random.nextInt(50) + 5,
                    random.nextFloat() + random.nextInt(50) + 5,
                    random.nextFloat() + random.nextInt(50) + 5);
            asteroids[i].setPos(((float) asteroidPosition.x) + (random.nextBoolean() ? random.nextInt(10) : -random.nextInt(10)),
                    ((float) asteroidPosition.y) + (random.nextBoolean() ?  random.nextInt(10) : -random.nextInt(10)),
                    ((float) asteroidPosition.z) + (random.nextBoolean() ?  random.nextInt(10) : -random.nextInt(10)));
