 ...
 */
public class ChangeShadowSizeEvent extends EntityEvent {
    ...
    public ChangeShadowSizeEvent(PoseStack matrixStack, MultiBufferSource renderTypeBuffer, Entity entity, float darkness, float partialTicks, LevelReader world, float size) {
        super(entity);
