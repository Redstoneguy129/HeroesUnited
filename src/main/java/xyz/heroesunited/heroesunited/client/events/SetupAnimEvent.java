 ...
 */
public class SetupAnimEvent extends PlayerEvent {

    private final PlayerModel playerModel;
    private final float limbSwing, limbSwingAmount, ageInTicks, netHeadYaw, headPitch, partialTicks;

    public SetupAnimEvent(AbstractClientPlayer playerEntity, PlayerModel playerModel, float limbSwing, float limbSwingAmount, float ageInTicks, float netHeadYaw, float headPitch) {
        super(playerEntity);
