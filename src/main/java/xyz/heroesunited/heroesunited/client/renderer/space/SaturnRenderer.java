...
import xyz.heroesunited.heroesunited.client.model.space.SaturnModel;

public class SaturnRenderer extends PlanetRenderer {
    public SaturnRenderer(ModelPart part) {
        super(new SaturnModel(part));
    }

    @Override
    public ResourceLocation getTextureLocation() {
        return new ResourceLocation(HeroesUnited.MODID, "textures/planets/saturn.png");
    }

    @Override
    public void render(PoseStack matrixStack, MultiBufferSource buffers, int packedLight, float partialTicks) {

        matrixStack.scale(4.45F, 4.45F, 4.45F);
