...
public class HUEntities {
    ...
    public static final EntityType<Spaceship> SPACESHIP = register("spaceship", EntityType.Builder.<Spaceship>of(Spaceship::new, EntityClassification.MISC).sized(2F, 10));
