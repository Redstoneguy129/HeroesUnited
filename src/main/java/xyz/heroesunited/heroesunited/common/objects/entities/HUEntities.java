...
public class HUEntities {
    ...
    public static final EntityType<Horas> HORAS = register("horas", EntityType.Builder.of(Horas::new, MobCategory.CREATURE).sized(.9F, 2.15F));
    ...
    public static final EntityType<Spaceship> SPACESHIP = register("spaceship", EntityType.Builder.<Spaceship>of(Spaceship::new, MobCategory.MISC).sized(5F, 10F));
