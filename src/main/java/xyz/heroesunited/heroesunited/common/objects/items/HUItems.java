...
public class HUItems {
    ...
    public static final RegistryObject<HorasItem> HORAS = ITEMS.register("horas", () -> new HorasItem(new Item.Properties().stacksTo(1)));
    ...
    public static final RegistryObject<GeckoAccessory> BOBO_ACCESSORY = ITEMS.register("bobo", () -> new GeckoAccessory(EquipmentAccessoriesSlot.HELMET));
