...
public class HUClientUtil {
    ...
    public static ModelPart getSuitModelPart(Entity entity) {
        ...
        if (entity instanceof AbstractClientPlayer && ((AbstractClientPlayer) entity).getModelName().equalsIgnoreCase("slim")){
    ...
    public static <M extends PlayerModel<AbstractClientPlayer>> void renderModel(PlayerRenderer renderer, M model, AbstractClientPlayer entity, PoseStack matrixStack, MultiBufferSource buffer, VertexConsumer builder, int light, int overlay, float red, float green, float blue, float alpha, float limbSwing, float limbSwingAmount, float ageInTicks, float headPitch, float netHeadYaw) {
